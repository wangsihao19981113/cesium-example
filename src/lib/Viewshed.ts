...
export class ViewShedStage {
    ...
    private viewPosition:Cesium.Cartesian3
    private viewPositionEnd:Cesium.Cartesian3
    private viewDistance
    private viewHeading
    private viewPitch
    private horizontalViewAngle
    private verticalViewAngle
    private visibleAreaColor
    private invisibleAreaColor
    private enabled
    private softShadows
    private size
    private sketch
    ...
    createShadowMap() {
        if(this.viewDistance < this.lightCamera.frustum.near){
            console.log(true)
        }
