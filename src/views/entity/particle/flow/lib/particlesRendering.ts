...
import {ParticleSystemOptions, ViewerParameters} from "@/packages/components/Features/Particle/Flow/wind/types";
import * as Cesium from 'cesium'
class ParticlesRendering {
  textures: any
  framebuffers: any
  primitives: any
  constructor(context:any, data:any, particleSystemOptions:any, viewerParameters:ViewerParameters, particlesComputing:any) {
  ...
  createRenderingFramebuffers(context:ViewerParameters) {
    this.framebuffers = {
  ...
  createSegmentsGeometry(particleSystemOptions:any) {
  ...
  createRenderingPrimitives(context:any, particleSystemOptions:ParticleSystemOptions, viewerParameters:ViewerParameters, particlesComputing:any) {
    const that = this
