...
class ParticleSystem {
  ...
  applyParticleSystemOptions(particleSystemOptions:ParticleSystemOptions) {
    ...
    Object.keys(particleSystemOptions).forEach(key => {
      this.particleSystemOptions[key as keyof ParticleSystemOptions] = particleSystemOptions[key as keyof ParticleSystemOptions]
    })
  ...
  applyViewerParameters(viewerParameters:ViewerParameters) {
    Object.keys(viewerParameters).forEach(key => {
      this.viewerParameters[key  as keyof ViewerParameters] = viewerParameters[key  as keyof ViewerParameters]
    })
