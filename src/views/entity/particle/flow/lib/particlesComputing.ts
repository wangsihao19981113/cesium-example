...
class ParticlesComputing {
  ...
  createParticlesTextures(context:any, particleSystemOptions:any, viewerParameters:any) {
  ...
  randomizeParticles(maxParticles:any, viewerParameters:any) {
  ...
  createComputingPrimitives(data:any, particleSystemOptions:any, viewerParameters:any, context:any) {
